                 ...
                 <div class="card-body">
                   ...
                   <form class="forms-sample" method="post" action="{{ route('product.add') }}" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="details_az" id="details_az"> </textarea>
                      </div>
                      <div class="form-group">
                     ...
                     <div class="form-group">
                       ...
                       <textarea name="details_ru" id="details_ru"> </textarea>
                     </div>


                     <div class="form-group">
                        <label for="shipping_az">Shipping (az)</label>
                        <textarea name="shipping_az" id="shipping_az"> </textarea>
                      </div>
                      <div class="form-group">
                       <label for="shipping_en">Shipping (en)</label>
                       <textarea name="shipping_en" id="shipping_en"> </textarea>
                     </div>
                     <div class="form-group">
                       <label for="shipping_ru">Shipping (ru)</label>
                       <textarea name="shipping_ru" id="shipping_ru"> </textarea>
                     </div>
