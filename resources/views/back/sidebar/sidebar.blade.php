        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('contact.index')}}">
              ...
              <span class="menu-title">Elaqe</span>
            </a>
          </li>
          ...
          {{-- <li class="nav-item">
            <a class="nav-link" href="{{route('admin.logout')}}">
              ...
              <span class="menu-title">Cixis</span>
            </a>
          </li> --}}
...
<br>
          ...
          @if($admin->id === 1)
          <li class="nav-item">
            <a class="nav-link" href="{{route('admin.all.admin')}}">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">Elaqe Melumatlari</span>
